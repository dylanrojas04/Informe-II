...
A0 = 1.48;  % Componente de corriente continua (DC)
A1 = 1.18;   % Amplitud fundamental de la señal
A3 = 0.097;   % Armónico 3
A5 = 0.033;  % Armónico 5
A7 = 0.018;  % Armónico 7
A9 = 0.0093;  % Armónico 9
A11 = 0.0077;  % Armónico 11
...
figure;
plot(t, VT);
title('Señal Reconstruida a partir de Armónicos Exp');
xlabel('Tiempo (s)');
ylabel('Amplitud');
grid on;
